...
public static class MenuHooks
{
    ...
    {
        //Methods.Methods.LogMethodStart("SLEEPANDDEATHSCREEN_GETDATAFROMGAME");

        //Methods.Methods.LogMessage("PACKAGE START MALNOURISHED: " + package.startMalnourished);
        //Methods.Methods.LogMessage("PACKAGE GOAL MALNOURISHED: " + package.goalMalnourished);

        //Methods.Methods.LogMessage("THIS START MALNOURISHED: " + self.startMalnourished);
        //Methods.Methods.LogMessage("THIS GOAL MALNOURISHED: " + self.goalMalnourished);
