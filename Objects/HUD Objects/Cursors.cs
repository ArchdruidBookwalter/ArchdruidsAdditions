...
public static class Cursors
{
    ...
    public class PointCursor : HudPart
    {
        ...
        public Vector2 pos = Vector2.zero, lastPos = Vector2.zero, rotation = Vector2.up;
        ...
        public override void Update()
        {
            ...
            if (bow != null && bow.aiming)
            {
                ...
                pos = bow.cursorPos.Value - bow.camPos;
        ...
        public override void Draw(float timeStacker)
        {
            ...
            try
            {
                ...
                else
                {
                    if (aimMode)
                    {
                        Vector2 cursorPos = Vector2.Lerp(lastPos, pos, timeStacker);
